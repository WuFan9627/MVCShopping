...
<FORM name=adminlogin action="com.web.controller/Login" method=post>
          ...
          <TD>
            <TABLE id=table2 cellSpacing=1 cellPadding=0 width="100%" 
              ...
              <TR>
                ...
                <TD>
			<input type="text" name="username" value="admin" size="18"/>
		</TD></TR><br>

              <TR>
                <TD align=middle width=81><FONT color=#ffffff>密码：</FONT>
                <TD>
